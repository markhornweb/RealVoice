    ...
    o.length &&
        o.flatpickr({
            ...
            onClose: function (t, a, e) {
                var l;
                new Date();
                null != t[0] && ((l = moment(t[0]).format("MM/DD/YYYY")), d.val(l)), null != t[1] && ((l = moment(t[1]).format("MM/DD/YYYY")), c.val(l)), $(o).trigger("change").trigger("keyup");
            },
        }),
        ($.fn.dataTableExt.afnFiltering.length = 0);
    var s,
            ...
            $(".dt-column-search thead tr:eq(1) th").each(function (t) {
                ...
                $(this).css("border-left", "none"),
                    ...
                    $("input", this).on("keyup change", function () {
                        s.column(t).search() !== this.value && s.column(t).search(this.value).draw();
                    });
            }),
            (s = a.DataTable({
